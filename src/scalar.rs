...
mod test {
    ...
    halo2curves::field_testing_suite!(Scalar, "field_arithmetic");
    halo2curves::field_testing_suite!(Scalar, "conversion");
    halo2curves::field_testing_suite!(Scalar, "serialization");
    halo2curves::field_testing_suite!(Scalar, "quadratic_residue");
    halo2curves::field_testing_suite!(Scalar, "bits");
    halo2curves::field_testing_suite!(Scalar, "serialization_check");
    halo2curves::field_testing_suite!(Scalar, "constants");
    halo2curves::field_testing_suite!(Scalar, "sqrt");
    halo2curves::field_testing_suite!(Scalar, "zeta");
    halo2curves::field_testing_suite!(Scalar, "from_uniform_bytes", 64);
}
